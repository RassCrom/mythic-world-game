...
export const RU_CARDS = {
  ...
  m_chronodrake: { name: 'Хронодракон', text: 'Когда эта карта входит в ваше логово, измените направление хода игры на противоположное.' },
  m_mirrorwing: { name: 'Зеркалокрыл', text: 'Когда эта карта входит в ваше логово, можете скопировать способность входа другого Магического дракона в любом логове.' },
  m_riftcoil: { name: 'Разломный змей', text: 'Когда эта карта входит в ваше логово, можете поменять её местами с драконом в логове другого игрока.' },
  m_hydra: { name: 'Дракон-гидра', text: 'Если эту карту приносят в жертву или уничтожают, можете привести до 2 дракончиков из Гнезда в своё логово.' },
  m_volcanic: { name: 'Вулканический змей', text: 'Когда эта карта входит в ваше логово, можете ПОЖЕРТВОВАТЬ всеми остальными драконами в своём логове. Если сделали это, УНИЧТОЖЬТЕ 2 карты за каждого принесённого в жертву дракона.' },
